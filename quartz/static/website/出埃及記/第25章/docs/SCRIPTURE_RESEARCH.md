...
> 2026-09-10：以下為既有研究方法與來源線索，不能代替逐項核對。新實作以 [REVAMP_EVIDENCE](planning/REVAMP_EVIDENCE.md) 為準；正式經文從庫根 raw_scripture 抽取，來源連結可在證據介面顯示。舊文的線上API／不顯示來源連結政策不再是本輪指示。
