...
// Use the same content directory that Quartz builds. Override this for a
// local fixture run: CONTENT_DIR=test_content node scripts/generate_embeddings.js
...
async function main() {
  ...
  for (const file of files) {
    ...
    for (let i = 0; i < chunks.length; i++) {
      ...
      const slug = normalizeSearchSlug(relativePath)
      if (!slug) continue
